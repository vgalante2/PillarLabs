...
function About() {
        ...
        gsap.fromTo(
            ...
            { y: -200, opacity: 0 },
            {
                ...
                scrollTrigger: {
                    ...
                    toggleActions: "restart none none none", // Defines what happens to the animation at certain scroll points
                }
            }
        );
    ...
    return ( 
        ...
        <svg ref={FlashRef} className={styles.svg} width="800px" height="1200px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
